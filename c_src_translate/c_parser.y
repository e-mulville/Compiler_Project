...
%type <statement> PROGRAM STATEMENT STATEMENT_LIST DECLARATION  ASSIGNMENT JUMP FUNC_DECLARATION VAR_DECLARATION ARGUMENT_LIST LOGIC LOGIC2 LOGIC3 LOGIC4 LOGIC5 EXPR EXPR2 EXPR3 VALUE ARGUMENT RETURN ASSIGN CONTROL IF  FUNC_EVOKE VALUE_WITH_FUNC
