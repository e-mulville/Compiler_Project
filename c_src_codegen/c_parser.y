...
VAR_DECLARATION : T_INT VALUE_FOR_STORE { $$ = new IntDeclaration($2, 1); }
		...
		| T_INT ARRAY_FOR_STORE { $$ = new ArrayDeclaration($2, 1); }
		| T_INT ARRAY_FOR_STORE T_SEMICOLON { $$ = new ArrayDeclaration($2, 0); }
